...
struct iterator {
	...
	iterator() { std::cout << "Base iterator" << std::endl; }
};
...
//	own base_iterator type for not writing huge ft::iterator<...>
...
public:
	...
	RandomAccessIterator(void) : _ptr(nullptr) { std::cout << "Random iterator" << std::endl; }
	RandomAccessIterator(pointer const ptr) : _ptr(ptr) { std::cout << "Random iterator" << std::endl; }
